...
class Project extends BaseController
{
    ...
    public function create(){
		...
		system("/usr/bin/python3 $raiz/app/ThirdParty/COCaDA/main.py -f $data_folder/$id/data.pdb -o $data_folder/$id");

		exec("/usr/bin/python3 $raiz/app/ThirdParty/COCaDA/main.py -f $data_folder/$id/data.pdb -o $data_folder/$id ");
		$saida = shell_exec("/usr/bin/python3 $raiz/app/ThirdParty/COCaDA/main.py -f $data_folder/$id/data.pdb -o $data_folder/$id");
		dd($saida);
