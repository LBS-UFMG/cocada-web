        ...
        <div class="row">
            <div class="col-md-9 col-12 pt-2">
                <h2 class="title_h2 pt-4">
                    ...
                    <div class="dropdown d-inline ms-2" title="Export files">
                        <div class="dropdown d-inline">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <hr>
                                <li><a class="dropdown-item mt-2" href="<?php echo base_url(); ?>data/pdb_biologicalassembly/<?= substr($id, 0, 1) ?>/<?= $id ?>/<?= $id ?>_contacts.csv">Contacts</a></li>
                                <li><a class="dropdown-item" href="https://files.rcsb.org/download/<?php echo strtoupper($id); ?>-assembly1.cif.gz">PDB file (assembly)</a></li>
                                <hr>
                    ...
                    <a href="<?= base_url("/entry/$id") ?>" class="btn btn-secondary">
...
<script> 
    ...
    $(document).ready(function() {
        ...
        // Estrutura do biological assembly (mmCIF baixado e descompactado do RCSB,
        // servido localmente a partir da pasta pdb_biologicalassembly)
        var txt = "<?php echo base_url(); ?>data/pdb_biologicalassembly/<?= substr($id, 0, 1) ?>/<?= $id ?>/<?= $id ?>-assembly1.cif";
...
<script>
    ...
    fetch('<?php echo base_url(); ?>data/pdb_biologicalassembly/<?= substr($id, 0, 1) ?>/<?= $id ?>/<?= $id ?>_contacts.csv')
