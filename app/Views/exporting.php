...
<div class="container py-5 text-secondary text-center">
    <div class="row">
        ...
        <div class="col">
            ...
            <p>If the download does not start automatically, click here to <a id="pse" href='<?php if(strlen($id)==6){ echo base_url("/data/projects/$id/contacts.pse"); } else{ echo base_url("/data/pdb/$id[0]/$id"."_contacts.pse"); } ?>'>Download the PSE file</a>.</p>
