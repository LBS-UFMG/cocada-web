    ...
    <div class="col-12 col-md-6 mt-2">
      ...
      <div class="row g-2">
        <div class="col-2 col-md-2">
          <input type="text" id="code1" name="code1" class="text-center form-control form-control-lg validacao px-3 py-4" size="1" maxlength="1">
        </div>
        <div class="col-2 col-md-2">
          <input type="text" id="code2" name="code2" class="text-center form-control form-control-lg validacao px-3 py-4" size="1" maxlength="1">
        </div>
        <div class="col-2 col-md-2">
          <input type="text" id="code3" name="code3" class="text-center form-control form-control-lg validacao px-3 py-4" size="1" maxlength="1">
        </div>
        <div class="col-2 col-md-2">
