...
<div class="container mt-5 border rounded p-5 bg-light" id="run">
  ...
  <p class="border rounded p-4 text-muted small">
    <strong>There are three ways to run COCaDA-web</strong> (1) Upload a file in PDB or CIF format (below - left); (2) enter the PDB/UniProt code to download data from PDB/AlphaFoldDB API (below - right); (3) use the <a class="link-dark" href="<?=base_url('/#search_pdb')?>">search bar</a> (Examples section - right) to access COCaDA-db pre-calculated structure contacts. COCaDA-db only supports PDB structures with up to 10,000 amino acid residues. To access structures with more than 10,000 residues, please upload your file.
  </p>
  <div class="row">
