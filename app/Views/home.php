...
<div class="container mt-5 border rounded p-5 bg-light" id="run">
  ...
  <div class="row">
    <div class="col-12 col-md-6 mt-2">
      <label class="badge bg-dark">Submit a PDB file <a class="link-dark" href="#" data-bs-placement="top" data-bs-toggle="tooltip" data-bs-title="Limit 10MB"><i class="bi bi-question-circle-fill"></i></a></label>
    ...
    <div class="col-12 col-md-6 border-start pb-3 mt-2">
      <label class="badge text-bg-light">or type a PDB ID or an UniProt/AlphaFoldDB ID <a class="link-dark" href="#" data-bs-placement="top" data-bs-toggle="tooltip" data-bs-title="You can enter a 4-character PDB code to download a file from the Protein Data Bank API (for a list of available PDB files, visit: https://www.rcsb.org). Optionally, you can enter a UniProt code to download an entry directly from the AlphaFoldDB API (for a list of available entries, visit: https://alphafold.ebi.ac.uk)."><i class="bi bi-question-circle-fill"></i></a></label>
