...
<div class="container mt-5 border rounded p-5 bg-light" id="run">
  ...
  <div class="row">
    <div class="col-12 col-md-6 mt-2">
      <label class="badge bg-dark">Submit a PDB file </label><a class="link-dark ms-1" href="#" data-bs-placement="top" data-bs-toggle="tooltip" data-bs-title="Accepted extensions: PDB or CIF. Limit 50MB"><i class="bi bi-question-circle-fill"></i></a>
