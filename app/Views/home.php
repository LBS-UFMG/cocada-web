...
<div class="container mt-5 border rounded p-5 bg-light" id="run">
  ...
  <p class="border rounded p-4 text-muted small">
    <strong>There are three ways to run COCaDA-web</strong>: (i) Upload a file in PDB or CIF format (below - left); (ii) enter the PDB/UniProt code to download data from PDB/AlphaFoldDB API (below - right); (iii) use the <a class="link-dark" href="<?=base_url('/#search_pdb')?>">search bar</a> (Examples section - right) to access COCaDA-db pre-calculated structure contacts. COCaDA-db only supports PDB structures with up to 10,000 amino acid residues. To access structures with more than 10,000 residues, please upload your file.
  </p>
  <div class="row">
    ...
    <div class="col-12 col-md-6 mt-2">
      ...
      <div class="row g-2">
        <div class="col-2 col-md-1">
          <input type="text" id="code1" name="code1" class="form-control form-control-lg validacao p-3" size="1" maxlength="1">
        </div>
        <div class="col-2 col-md-1">
          <input type="text" id="code2" name="code2" class="form-control form-control-lg validacao p-3" size="1" maxlength="1">
        </div>
        <div class="col-2 col-md-1">
          <input type="text" id="code3" name="code3" class="form-control form-control-lg validacao p-3" size="1" maxlength="1">
        </div>
        <div class="col-2 col-md-1">
          <input type="text" id="code4" name="code4" class="form-control form-control-lg validacao p-3" size="1" maxlength="1">
        </div>
        <div class="col-2 col-md-1">
